...
- **Subagents**: no subagent/task spawning dependency — quick 3-question and full 11-dimension modes run on the main agent (see the "no-subagent platforms" note in SKILL.md).
